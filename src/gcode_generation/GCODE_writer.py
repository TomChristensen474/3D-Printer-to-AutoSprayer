...
class GCODE_writer:
    ...
    def __init__(self, file_name="Spray_scan.gcode"):
        ...
        self.file_handler.write(
            "(This Gcode is automatically generated to control the movement of a spray coater)\n\n"
        )
    ...
    def Temperature(self, Temperature, Offset=10):
        self.file_handler.write(
            f"M140 S{Temperature}\n"
        )  # Set the bed target temperature
        self.file_handler.write(
            f"M190 S{Temperature - Offset}\n"
